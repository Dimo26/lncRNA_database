...
#SBATCH -p core
#SBATCH -n 2
#SBATCH -t 06:20:00 # can be increased when repopulating the database. 
...
python /proj/sens2023005/nobackup/wharf/dimam/dimam-sens2023005/lncRNA_DB_codes/search_functions.py --search-type lncrna-to-gene --lncrna HOTAIR --export csv
